...
\colorlet{myred}{blue!70!black}
\colorlet{myblue}{blue!70!black}
\colorlet{mydarkred}{blue!40!black}
...
\tikzstyle{detector surface}=[blue!60!black!60,opacity=0.06,rotate around z=\ang]
\usetikzlibrary{angles,quotes} % for pic (angle labels)
\newcommand*{\vv}[1]{\vec{\mkern0mu#1}} % aligned vector arrow

\begin{document}

% ALICE detector - left perspective
...
\begin{tikzpicture}[scale=2.8,tdplot_main_coords,rotate around x=90]
  ...
  \draw[->,red,line cap=round] (O') -- (Pxy) node[anchor=270] {$\vv{p_\mathrm{T}}$};
